...
def test_registration_page_with_empty_name_field(web_browser):
    ...
    reg_page.last_name_field.send_keys("Соколова")
    reg_page.email_or_mobile_phone_field.send_keys("g.k.hope@mail.ru")
    reg_page.password_field.send_keys("1234554321Gk")
    reg_page.password_confirmation_field.send_keys("1234554321Gk")
...
def test_registration_with_an_incorrect_value_in_the_last_name_field(web_browser):
    ...
    reg_page.last_name_field.send_keys("прпрпрпрпрпрпрппрпрпрпрпрпрарарар")
    reg_page.email_or_mobile_phone_field.send_keys("g.k.hope@mail.ru")
    reg_page.password_field.send_keys("1234554321Gk")
    reg_page.password_confirmation_field.send_keys("1234554321Gk")
    reg_page.continue_button.click()
...
def test_registration_of_an_already_registered_user(web_browser):
    ...
    auth_page.registration_link.click()
    reg_page = RegPage(web_browser, auth_page.get_current_url())
    reg_page.name_field.send_keys("Надежда")
    reg_page.last_name_field.send_keys("Соколова")
    reg_page.email_or_mobile_phone_field.send_keys("+79183131838")
    reg_page.password_field.send_keys("1234554321Gk")
    reg_page.password_confirmation_field.send_keys("1234554321Gk")
    reg_page.continue_button.click()
...
def test_incorrect_password_during_registration(web_browser):
    ...
    reg_page.email_or_mobile_phone_field.send_keys("g.k.hope@yandex.ru")
    reg_page.password_field.send_keys("12Aa34#")
    reg_page.password_confirmation_field.send_keys("12Aa34#")
    reg_page.continue_button.click()
...
def test_password_and_password_confirmation_do_not_match(web_browser):
    ...
    reg_page.email_or_mobile_phone_field.send_keys("g.k.hope@mail.ru")
    reg_page.password_field.send_keys("1234554321Gk")
    reg_page.password_confirmation_field.send_keys("1234554321Gм")
    reg_page.continue_button.click()
...
def test_authorization_of_a_user_with_an_invalid_password(web_browser):
    page = AuthPage(web_browser)
    page.phone.send_keys('+7983131838')
...
def test_authorisation_valid(web_browser):
    page = AuthPage(web_browser)
    page.phone.send_keys("+79183131838")
    page.password.send_keys("1234554321Gk")
    page.btn_login.click()
